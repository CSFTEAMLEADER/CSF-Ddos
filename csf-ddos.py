...
{"THIS IS POWERFUL DDOS TOOL BY CYBER SHIELD FORCE":^50}

{"RUN ONLY IN CLOUD SHELL, DON'T RUN ON TERMUX":^50}

{" Coder: Lullu-Bhoot ðŸ‘»"}

{"Telegram: https://t.me/CSFTEAM3"}

{"Github: https://github.com/Cyber-Shield-Force"}
...
if __name__ == "__main__":
    ...
    print("Powerfull DDoS By:Cyber Shield Force")
